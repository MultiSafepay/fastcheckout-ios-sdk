...
typedef SWIFT_ENUM_NAMED(NSInteger, FCOAnalyticsEventType, "AnalyticsEventType", closed) {
/// Cart was shown
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, FCOBiometricAuthenticationStatus, "BiometricAuthenticationStatus", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, FCOConsumerStatus, "ConsumerStatus", closed) {
...
typedef SWIFT_ENUM_NAMED(NSInteger, FCOErrorAnalyticsEventType, "ErrorAnalyticsEventType", closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM(NSInteger, FCOTransactionState, closed) {
...
- (nonnull instancetype)initWithApiKey:(NSString * _Nonnull)apiKey settings:(FCOCoreSettings * _Nullable)settings OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly, strong) FCOOrderSummary * _Nullable relatedOrder;
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, FCOMessagesFilter, "MessagesFilter", closed) {
/// Inbox filter
...
/// returns:
/// Instance of Settings
- (nonnull instancetype)initWithEnvironment:(NSString * _Nonnull)environment debug:(BOOL)debug biometricAuthenticationEnabled:(BOOL)biometricAuthenticationEnabled persistUserSession:(BOOL)persistUserSession skipShowCartAtBeginning:(BOOL)skipShowCartAtBeginning OBJC_DESIGNATED_INITIALIZER;
...
typedef SWIFT_ENUM_NAMED(NSInteger, FCOShippingStatus, "ShippingStatus", closed) {
...
///   </li>
/// </ul>
typedef SWIFT_ENUM_NAMED(NSInteger, FCOSocialProvider, "SocialProvider", closed) {
/// Google
...
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id siteId:(NSString * _Nonnull)siteId name:(NSString * _Nonnull)name desc:(NSString * _Nullable)desc url:(NSURL * _Nonnull)url imageURL:(NSURL * _Nonnull)imageURL OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
